...
import { FormComponent } from './pages/product/details/form/form.component';
import { FeedbackBoxComponent } from './pages/product/details/feedback-box/feedback-box.component';
